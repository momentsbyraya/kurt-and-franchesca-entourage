            ...
            <div className="text-center mb-12">
              <h2 ref={headerRef} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-8">
                ...
                <div className="flex flex-col items-center justify-center">
                  {/* Groom's Name */}
                  <div>
                    <p className="font-tebranos text-4xl sm:text-5xl md:text-6xl lg:text-7xl uppercase leading-tight" style={{ color: '#b86e7e' }}>
                  ...
                  <p className="caudex-bold text-base sm:text-lg md:text-xl lg:text-2xl uppercase leading-tight my-1" style={{ color: '#b86e7e' }}>
                    AND
                  </p>
                  {/* Bride's Name */}
                  <div>
                ...
                {/* NUPTIALS */}
                <div className="caudex-bold text-base sm:text-lg md:text-xl lg:text-2xl block leading-none uppercase mt-8" style={{ lineHeight: '0.8', color: '#b86e7e' }}>
                  NUPTIALS
                </div>
              </h2>
            </div>
            ...
            <div className="space-y-10 entourage-names-single-line">
              ...
              <div ref={parentsRef} className="flex flex-row gap-6 sm:gap-10 justify-center items-start">
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-3 text-right uppercase" style={{ color: '#b86e7e' }}>Parents of the Groom</p>
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-3 text-left uppercase" style={{ color: '#b86e7e' }}>Parents of the Bride</p>
              ...
              {principalSponsors && (
                <div ref={principalSponsorsRef}>
                  <h3 className="text-lg sm:text-xl md:text-2xl imperial-script-regular font-bold mb-6 text-center" style={{ color: '#b86e7e' }}>Principal sponsors</h3>
                  <div className="flex flex-row gap-6 sm:gap-10 justify-center items-start">
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-right uppercase" style={{ color: '#b86e7e' }}>Ninong</p>
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-left uppercase" style={{ color: '#b86e7e' }}>Ninang</p>
                      <div className="space-y-1.5">
              ...
              <div className="flex flex-row gap-6 sm:gap-10 justify-center items-start">
                {bestman && (
                  <div ref={bestmanRef} className="flex-1 min-w-0">
                    <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-right uppercase" style={{ color: '#b86e7e' }}>Best Man</p>
                ...
                {maidOfHonor && (
                  <div ref={maidOfHonorRef} className="flex-1 min-w-0">
                    <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-left uppercase" style={{ color: '#b86e7e' }}>Maid of Honor</p>
              ...
              <div>
                ...
                {secondarySponsors && (
                  <div ref={secondarySponsorsRef} className="flex flex-row gap-6 sm:gap-10 justify-center items-start">
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-right uppercase" style={{ color: '#b86e7e' }}>Groomsmen</p>
                      <div className="space-y-1.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-left uppercase" style={{ color: '#b86e7e' }}>Bridesmaids</p>
                      <div className="space-y-1.5">
              ...
              {ringBearer && (
                <div ref={ringBearerRef} className="flex flex-col gap-1 justify-center items-center">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#b86e7e' }}>Ring Bearer</p>
              ...
              {bibleBearer && (
                <div ref={bibleBearerRef} className="flex flex-col gap-1 justify-center items-center">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#b86e7e' }}>Bible Bearer</p>
              ...
              {coinBearer && (
                <div ref={coinBearerRef} className="flex flex-col gap-1 justify-center items-center">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#b86e7e' }}>Coin Bearer</p>
              ...
              {flowerBoys && (
                <div ref={flowerBoysRef} className="flex flex-col gap-1 justify-center items-center">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#b86e7e' }}>Flower Boy</p>
              ...
              {flowerGirls && (
                <div ref={flowerGirlsRef} className="flex flex-col gap-1 justify-center items-center">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] caudex-bold mb-2 text-center uppercase" style={{ color: '#b86e7e' }}>Flower Girls</p>
